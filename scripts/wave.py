...
homep = df[df['inning_topbot'] == 'Bot'][['pitcher', 'away_team', 'game_date']].drop_duplicates().rename(columns = {'away_team' : 'team'})
awayp = df[df['inning_topbot'] == 'Top'][['pitcher', 'home_team', 'game_date']].drop_duplicates().rename(columns = {'home_team' : 'team'})
...
latest_pitcher_team = latest_pitcher.merge(teamp, on = ['pitcher', 'game_date'], how = 'left')[['pitcher', 'team']].rename(columns = {'pitcher' : 'key_mlbam'})
...
nf = record.sort_values(['team', 'game_id']).reset_index()
